    ...
    if (isset($_POST['username'])) {
        ...
        if ($count >0) {
            ...
            if($row['role'] ==1){
                ...
                $query    = "SELECT * FROM `appartment` WHERE email = '$email'";
                $result = mysqli_query($con, $query) or die(mysql_error());
                $row = mysqli_fetch_assoc($result);
                echo $row['appartment_type'];
                 if($row['appartment_type'] == 'onebhk'){
                    header("Location: onebhk/home.php");
                 }
                 if($row['appartment_type'] == 'twobhk'){
                    header("Location: twobhk/home.php");
                 }
                 if($row['appartment_type'] == ''){
