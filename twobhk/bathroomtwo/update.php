    ...
    if(isset($_GET['token'])){
        ...
        if(mysqli_num_rows($checkTokenRes)>0){
            ...
            if($checkTokenRow['status'] == 1){
                ...
                if(isset($_GET['pin1'])){
                    $pin     = $_GET['pin1'];
                    $sqlRes    = "UPDATE bathroomtwo SET pin1 ='$pin'  WHERE email = '$email'";
                ...
                if(isset($_GET['pin2'])){
                    $pin     = $_GET['pin2'];
                    $sqlRes    = "UPDATE bathroomtwo SET pin2 ='$pin'  WHERE email = '$email'";
                ...
                if(isset($_GET['pin3'])){
                    $pin     = $_GET['pin3'];
                    $sqlRes    = "UPDATE bathroomtwo SET pin3 ='$pin'  WHERE email = '$email'";
                ...
                if(isset($_GET['pin4'])){
                    $pin     = $_GET['pin4'];
                    $sqlRes    = "UPDATE bathroomtwo SET pin4 ='$pin'  WHERE email = '$email'";
                ...
                if(isset($_GET['pin5'])){
                    $pin     = $_GET['pin5'];
                    $sqlRes    = "UPDATE bathroomtwo SET pin5 ='$pin'  WHERE email = '$email'";
